...
public class CommonMethods {
    ...
    public static void assertWebElementText(WebDriver driver, By findBy, String elementText) {
        ...
        Assert.assertTrue("Find /selection criterion (By) must find exactly one instance!", elements.size() == 1);
    ...
    public static void assertPageTitle(WebDriver driver, String text) {
        Assert.assertTrue("Page title is not displayed correctly", driver.getTitle().contains(text));
    }
